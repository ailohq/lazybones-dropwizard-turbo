...
public abstract class IntegrationTest extends JsonFixtureTest {
    ...
    @ClassRule
    public static final DropwizardAppRule<SampleApplicationConfiguration> RULE =
            new DropwizardAppRule<>(SampleApplication.class, resourceFilePath("applicationname-test.yml"));
